...
<body style="background: #ECF0F5;padding:0;margin:0">
  ...
  <tr>
    <td colspan="3" style="text-align: right;border-right: 1px solid blue">Total Price</td><th style="border: 1px solid blue;"><?php echo $total-$_POST['discount']; ?></th>
  </tr>
  <tr>
    <td class="center" colspan="4"><button class="btn btn-primary" onclick="window.print()">Print</button> <a href="index.php"><button class="btn btn-success">Back</button></a></td>
  </tr>
      </table>
    </div>
  </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="safeIn">Complete the Bill</button>
      </div>
    </form>
    </div>
